...
public class CustomSort { 
	...
	public static Stack sort(stack b, int size) throws Exception 
	{
	...
	public static Stack fixedStackSort(stack b, int size) throws Exception 
	{
		Stack<Integer> unsorted = new Stack<>();
		unsorted = Client.fixedStack();
		Stack<Integer> sorted = new Stack<>();
		sorted.push(unsorted.pop());
		while (!unsorted.isEmpty()) 
		{
